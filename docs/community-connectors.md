...
- Current news: TechCrunch and VentureBeat WordPress JSON plus best-effort BBC-linked public feeds. The product UI should quietly use sources that respond and hide source failures from the main experience.
